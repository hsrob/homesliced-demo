...
using JSPlayground.Controllers;
...
[assembly: WebActivator.PreApplicationStartMethod(typeof(JSPlayground.App_Start.AppHost), "Start")]
...
namespace JSPlayground.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("StarterTemplate ASP.NET Host", typeof(HomeController).Assembly) { }
